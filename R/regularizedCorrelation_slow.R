#' regularizedCorrelation_slow
#'
#' \code{regularizedCorrelation_slow} regularizes a phenotypic, genetic, or residual correlation matrix
...
#' @keywords internal
#'
regularizedCorrelation_slow <- function(data, folds = 5, what = "genetic", dopar = FALSE, penalty = NULL, verbose = TRUE) {
